...
/**
 * A {@link HttpMessageConverter} for an {@link PatTokenIntrospection Pat Introspection Response}.
 *
 * @see AbstractHttpMessageConverter
 * @see PatTokenIntrospection
 */
public class PatTokenIntrospectionHttpMessageConverter
		extends AbstractHttpMessageConverter<PatTokenIntrospection> {
	...
	private Converter<Map<String, Object>, PatTokenIntrospection> tokenIntrospectionConverter = new MapOAuth2TokenIntrospectionConverter();

	private Converter<PatTokenIntrospection, Map<String, Object>> tokenIntrospectionParametersConverter = new PatTokenIntrospectionMapConverter();

	public PatTokenIntrospectionHttpMessageConverter() {
		super(MediaType.APPLICATION_JSON, new MediaType("application", "*+json"));
	}

	@Override
	protected boolean supports(Class<?> clazz) {
		return PatTokenIntrospection.class.isAssignableFrom(clazz);
	}

	@Override
	@SuppressWarnings("unchecked")
	protected PatTokenIntrospection readInternal(Class<? extends PatTokenIntrospection> clazz,
	...
	@Override
	protected void writeInternal(PatTokenIntrospection tokenIntrospection, HttpOutputMessage outputMessage)
	...
	public final void setTokenIntrospectionConverter(
			Converter<Map<String, Object>, PatTokenIntrospection> tokenIntrospectionConverter) {
	...
	public final void setTokenIntrospectionParametersConverter(
			Converter<PatTokenIntrospection, Map<String, Object>> tokenIntrospectionParametersConverter) {
	...
	private static final class MapOAuth2TokenIntrospectionConverter
			implements Converter<Map<String, Object>, PatTokenIntrospection> {
		...
		private MapOAuth2TokenIntrospectionConverter() {
			...
			claimConverters.put(PatTokenIntrospectionClaimNames.ACTIVE, booleanConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.SCOPE,
					MapOAuth2TokenIntrospectionConverter::convertScope);
			claimConverters.put(PatTokenIntrospectionClaimNames.CLIENT_ID, stringConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.USERNAME, stringConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.TOKEN_TYPE, stringConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.EXP, instantConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.IAT, instantConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.NBF, instantConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.SUB, stringConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.AUD, collectionStringConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.ISS, urlConverter);
			claimConverters.put(PatTokenIntrospectionClaimNames.JTI, stringConverter);
			this.claimTypeConverter = new ClaimTypeConverter(claimConverters);
		}

		@Override
		public PatTokenIntrospection convert(Map<String, Object> source) {
			Map<String, Object> parsedClaims = this.claimTypeConverter.convert(source);
			return PatTokenIntrospection.withClaims(parsedClaims).build();
		}
	...
	private static final class PatTokenIntrospectionMapConverter
			implements Converter<PatTokenIntrospection, Map<String, Object>> {

		@Override
		public Map<String, Object> convert(PatTokenIntrospection source) {
