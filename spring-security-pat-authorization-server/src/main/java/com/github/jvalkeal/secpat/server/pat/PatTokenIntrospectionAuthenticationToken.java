...
/**
 * An {@link Authentication} implementation used for Pat Introspection.
 *
...
public class PatTokenIntrospectionAuthenticationToken extends AbstractAuthenticationToken {
	...
	private final PatTokenIntrospection tokenClaims;
	 ...
	 */
	public PatTokenIntrospectionAuthenticationToken(String token, Authentication clientPrincipal,
		...
		this.tokenClaims = PatTokenIntrospection.builder().build();
	}
	 ...
	 */
	public PatTokenIntrospectionAuthenticationToken(String token, Authentication clientPrincipal,
			PatTokenIntrospection tokenClaims) {
		super(Collections.emptyList());
		Assert.hasText(token, "token cannot be empty");
		Assert.notNull(clientPrincipal, "clientPrincipal cannot be null");
	 ...
	 */
	public PatTokenIntrospection getTokenClaims() {
